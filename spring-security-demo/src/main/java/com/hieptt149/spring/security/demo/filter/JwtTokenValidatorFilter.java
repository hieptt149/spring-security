package com.hieptt149.spring.security.demo.filter;
                ...
                if (null != env) {
                    ...
                    if (null != secretKey) {
                        Claims payload = Jwts.parser()
                                ...
                                .getPayload();
                        String username = String.valueOf(payload.get(JwtConstants.JWT_CLAIM_USERNAME));
                        String authorities = String.valueOf(payload.get(JwtConstants.JWT_CLAIM_AUTHORITIES));
